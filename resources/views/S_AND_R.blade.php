...
<h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Shipping & Returns</h1>
  ...
  <div class="row text-center text-md-left">
    ...
    <img class="card-img-top  animated pulse infinite slow" src="https://codyhouse.co/demo-templates/mercurio/assets/img/card-v8-img-3.jpg" alt="not found image">
    </div>
    ...
    <p class="text-muted" style="margin-top:-20px;">
        <strong>
            <ul align="left">
                ...
                <li>For any enquiry regarding your order you can directly contact us by contacting our customer service via live chat on our website.</li>
                <li>For any inquiries, please contact us at<a href="https://console.dialogflow.com/api-client/demo/embedded/cb47dc52-b61f-46da-afa4-5339d7986703" target="_blank" style=" font-family: 'Balsamiq Sans', cursive;"> &#9829; GIFT STORE &#9829;</a></li>
            </ul>
        </strong>
    </p>
    </div>
