...
<?php $__env->startSection('content'); ?>
    <div align="center" style="background:#1CD5E8;padding:20px;">
        ...
        <p class="white-text" style="font-weight:bold;">
            <a href="<?php echo e(url('admin-products')); ?>" class="badge badge-pill btn-green   disabled px-3 py-2"> <i
                        ...
                        <tbody>
                            <?php $__currentLoopData = $Products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo e(url('admin-product-edit/' . $item->id)); ?>"
                                            class="badge badge-pill btn-primary px-3 py-2">Edit</a>
                                        <a href="<?php echo e(url('admin-product-delete/' . $item->id)); ?>"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/dashboards/admin/Products/index.blade.php ENDPATH**/ ?>