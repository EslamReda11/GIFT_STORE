 ...
 <?php $__env->startSection('content'); ?>
     ...
     <div class="container py-5">
         ...
         <div class="col-md-12">
             <div class="card">
                 <div class="card-body">
                     <form method="POST" action="<?php echo e(url('admin-product-update/' . $Products->id)); ?>"
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="name"
                                                 placeholder="Enter Name" value="<?php echo e($Products->name); ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="url"
                                                 placeholder="Custom URL" value="<?php echo e($Products->url); ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="number" name="priority" min="0" class="form-control"
                                                 value="<?php echo e($Products->priority); ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="number" name="Discount" min="0" class="form-control"
                                                 value="<?php echo e($Products->discount); ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <select class="form-control" name="rating">
                                                 <option value="<?php echo e($Products->rating); ?>" disabled><?php echo e($Products->rating); ?>
                                 ...
                                 <div class="row px-5 py-3">
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="<?php echo e(asset('Uploads/Products/' . $Products->image1)); ?>" width="50px;"
                                                 alt="<?php echo e($Products->image1); ?>" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="<?php echo e(asset('Uploads/Products/' . $Products->image2)); ?>" width="50px;"
                                                 alt="<?php echo e($Products->image2); ?>" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="<?php echo e(asset('Uploads/Products/' . $Products->image3)); ?>" width="50px;"
                                                 alt="<?php echo e($Products->image3); ?>" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="<?php echo e(asset('Uploads/Products/' . $Products->image4)); ?>" width="50px;"
                                                 alt="<?php echo e($Products->image4); ?>" />
                                         </div>
                                     </div>
                                     <div class="col-md-12">
                                         <div class="form-group">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="number" class="form-control" name="delivery_charges" required
                                                 ...
                                                 value="<?php echo e($Products->delivery_charges); ?>">
                                         </div>
                                     </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/dashboards/admin/Products/edit.blade.php ENDPATH**/ ?>