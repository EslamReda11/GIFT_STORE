...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container py-2">
        ...
        <p align="center">
            <img src="<?php echo e(asset('Uploads/profiles/admin.png')); ?>" class="img-fluid" style="width:70px;">
        </p>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-dark      text-white mb-4">
                    <div class="card-body"> <i class="fas fa-receipt"></i> Transactions</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/dashboards/admin/index.blade.php ENDPATH**/ ?>