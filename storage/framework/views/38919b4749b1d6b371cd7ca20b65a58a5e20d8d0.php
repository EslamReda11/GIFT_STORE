    ...
    <div id="About" class="container-fluid" style="background:white;">
        ...
        <div class="row ">
            <div class="col-md-4 wow animated zoomIn slow">
                <img src="<?php echo e(asset('Img/About.png')); ?>" alt="" class="img-fluid">
            </div>
    ...
    <section id="Products" align="center" class="px-5 wow animated fadeInUpBig fast"
        ...
        <div class="row my-4 px-4 ">
            <?php $__currentLoopData = $Products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 px-4 my-5" style="width:100%;height:380px ;">
                    <a href="<?php echo e(url('Shop/' . $item->url)); ?>">
                        <img src=" <?php echo e(asset('Uploads/Products/' . $item->image1)); ?>" alt="image" class="img-fluid" style="width:400px;height:280px;background-size:cover; ">
                    </a>
                    <div class="py-2" style="background:white;">
                        ...
                        <br>
                        Price :  <?php echo e($item->price); ?> EGP<br>
                        ...
                        <div align="center" class="container_ShopNow">
                            <button align="center" class=" button_ShopNow" onclick="goToShop('<?php echo e(url('Shop/' . $item->url)); ?>')" >Shop Now</button>
                        </div>
                        <script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/welcome.blade.php ENDPATH**/ ?>