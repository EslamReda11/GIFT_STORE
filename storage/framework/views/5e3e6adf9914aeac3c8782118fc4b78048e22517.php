...
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-5 py-2" style="background:#1CD5E8;margin-top:5px;">
        <h5 class="my-2"> <a href="/" class="black-text">Home</a> <strong class="black-text"> > <a
                    href="<?php echo e(url('cart')); ?>" class="black-text">Cart </a> > <a href="" class="white-text">Check out
                </a> </strong> </h5>
                    ...
                    <ul class="card    p-3" style=" list-style: none;">
                        ...
                        <?php if(session('cart')): ?>
                            ...
                            <li>
                                ...
                                <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <p align="left" style="float:left;">
                                        ...
                                        <img src="<?php echo e(asset('Uploads/Products/' . $details['item_image'] . '')); ?>"
                                            width="15px"> <?php echo e($details['item_name']); ?>


                                    </p>

                                    <p align="right">
                                        <?php echo e($details['item_quantity']); ?> &#8727;  <?php echo e($details['Final_Price']); ?> EGP
                                ...
                                <?php if(session('promocode')): ?>
                                    <p align="right">
                                        <span class="cart-grand-total-price">
                                            <strike class="red-text" style="font-size:15px;"><?php echo e($total); ?>/-</strike>
                                        </span>
                                        <span class="green-text" style="font-size:20px;"><?php echo e($total - (session('discount') * $total) / 100); ?> /-
                                        </span><br>
                                        <span class="green-text" style="font-size:15px;"> <?php echo e(session('discount')); ?> <?php echo e(session('message')); ?> </span>
                                    </p>
                                <?php else: ?>
                                    <p align="right">
                                        <i></i> <?php echo e($total); ?> EGP
                                    </p>
                            ...
                            <li>
                                ...
                                <h4 align="right">
                                    <i></i> <strong>
                                        <?php echo e($total + $delivery_charges - (session('discount') * $total) / 100); ?> EGP</strong>
                                </h4>
                            </li>
                        <?php endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/Product-Order-Screens/checkout.blade.php ENDPATH**/ ?>