...
<?php $__env->startSection('content'); ?>
    <div align="left" class="px-5 py-2" style="background:#1CD5E8;margin-top:5px; ">
        ...
        <p class="my-2 " style="font-weight:bold; "><a href="<?php echo e(url('/')); ?>" class="black-text">Home </a>/
        ...
        <div class="product_data px-3 py-5  ">
            ...
            <div class="row  d-flex align-items-center ">
                <div class="col-md-4  animated fadeInRight fast" style="width: 100%;">
                    ...
                    <img class="xzoom img-fluid" id="main_image" src="<?php echo e(asset('Uploads/Products/' . $Product->image1)); ?>"
                        xoriginal="<?php echo e(asset('Uploads/Products/' . $Product->image1)); ?>" style="width:400px;hight:400px;">
                    <!-- Thumbnails -->
                    <br> <br>
                    <?php if($Product->image2 == '' && $Product->image3 == '' && $Product->image4 == ''): ?>
                    <?php else: ?>
                        <a href="<?php echo e(asset('Uploads/Products/' . $Product->image1)); ?>">
                            <img class="xzoom-gallery" style="width:60px;hight:80px;"
                                src="<?php echo e(asset('Uploads/Products/' . $Product->image1)); ?>">
                        </a>
                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(asset('Uploads/Products/' . $Product->image2)); ?>">
                            <img class="xzoom-gallery" style="width:60px;hight:80px;"
                                src="<?php echo e(asset('Uploads/Products/' . $Product->image2)); ?>"
                                xpreview="<?php echo e(asset('Uploads/Products/' . $Product->image2)); ?>">
                        </a>
                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(asset('Uploads/Products/' . $Product->image3)); ?>">
                            <img class="xzoom-gallery" style="width:60px;hight:80px;"
                                src="<?php echo e(asset('Uploads/Products/' . $Product->image3)); ?>">
                        </a>
                    <?php endif; ?>
                    <?php if($Product->image3 == ''): ?>
                    <?php else: ?>
                        <a href="<?php echo e(asset('Uploads/Products/' . $Product->image4)); ?>">
                            <img class="xzoom-gallery" style="width:60px;hight:80px;"
                                src="<?php echo e(asset('Uploads/Products/' . $Product->image4)); ?>">
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div id="product_data" class="col-md-7 animated fadeInLeft fast">
                    ...
                    <input type="hidden" name="product_id" min=0 value="<?php echo e($Product->id); ?>" required
                        class="form-control product_id">
                    <p> Price : <strong style="font-size:20px;font-family: 'Balsamiq Sans', cursive;"> EGP
                            <?php echo e($Product->price); ?></strong></p>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Store\resources\views/Product-Order-Screens/Product_Page.blade.php ENDPATH**/ ?>